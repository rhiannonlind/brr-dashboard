    ...
    <>
      <div className='w-[80%] h-[calc(100vh-200px)] flex flex-col justify-start items-center bg-gray-400 mx-auto my-[1rem] py-4'>
        ...
        <div className='w-[90%] overflow-auto px-2'>
          {/* Header Row */}
          <div className="w-full h-auto bg-gray-200 grid m-0 sticky top-0" style={{ gridTemplateColumns: gridColumns }}>
          ...
          {data.rows.map((row, index) => (
            <div key={index} className="w-full h-auto bg-white grid m-0 border-b border-gray-200" style={{ gridTemplateColumns: gridColumns }}>
